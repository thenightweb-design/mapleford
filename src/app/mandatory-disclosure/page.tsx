                ...
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-100">
                      <th className="px-8 py-6 text-sm font-black uppercase tracking-widest text-[#d0302b] w-24">Sl No.</th>
                      <th className="px-8 py-6 text-sm font-black uppercase tracking-widest text-[#d0302b]">List of Documents</th>
                      <th className="px-8 py-6 text-sm font-black uppercase tracking-widest text-[#d0302b] text-center w-48">Download</th>
                    </tr>
                  </thead>
                  <tbody>
                    {disclosureData.map((item, index) => (
                      ...
                      >
                        ...
                        <td className="px-8 py-6 font-black text-[#000000] text-lg uppercase tracking-tight">{item.title}</td>
