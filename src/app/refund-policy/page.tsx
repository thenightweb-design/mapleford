      ...
      <div className="pt-[90px] lg:pt-[120px] overflow-hidden">
        ...
        <section className="py-16 sm:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h2 className="text-[32px] sm:text-[44px] font-bold text-[#1A1A1A] mb-8 tracking-tighter ">
                Refund Policy
              </h2>
              <div className="space-y-6 text-lg leading-relaxed font-medium">
                ...
                <h3 className="text-2xl font-bold text-[#d0302b] mt-8">Admission Fees</h3>
                <p>
                  The Admission Fee and Registration Fee are non-refundable under any circumstances.
                </p>
                <h3 className="text-2xl font-bold text-[#d0302b] mt-8">Tuition Fees</h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#d0302b] mt-8">Process</h3>
                <p>
