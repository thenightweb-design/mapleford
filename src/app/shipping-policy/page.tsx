          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <div className="space-y-6 text-lg leading-relaxed font-medium">
                ...
                <h3 className="text-2xl font-bold text-[#d0302b] mt-8">Delivery</h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#d0302b] mt-8">Exchange Policy</h3>
                <p>
                ...
                <h3 className="text-2xl font-bold text-[#d0302b] mt-8">Claims</h3>
                <p>
