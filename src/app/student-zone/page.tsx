      ...
      <div className="pt-[90px] lg:pt-[120px] overflow-hidden">
        ...
        <section className="py-24 px-4 text-center relative overflow-hidden min-h-[400px] flex items-center justify-center bg-[#d0302b]">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              ...
              <p className="!text-white/90 text-xl lg:text-2xl mt-4 max-w-2xl mx-auto font-bold leading-relaxed italic uppercase tracking-wider">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
                <p className="text-[#d0302b] font-bold uppercase tracking-[0.4em] text-xs mb-4">Four Elements. One Unstoppable Spirit.</p>
                <h2 className="text-[26px] sm:text-[38px] lg:text-[48px] font-bold leading-none uppercase tracking-tighter text-[#000000]">
                  The House Arena
                </h2>
                  ...
                  <div className="relative p-10 sm:p-14 text-white flex flex-col h-full z-10 overflow-hidden">
                    ...
                    <div className="flex justify-between items-start mb-12">
                      ...
                      <div className="text-right">
                        <p className="text-white/60 text-sm font-bold uppercase tracking-[0.2em] mb-1">{house.text}</p>
                        <h3 className="text-4xl lg:text-5xl font-bold uppercase tracking-tighter leading-none">{house.name}</h3>
                      </div>
                    </div>
                    ...
                    <div className="mt-auto space-y-8">
                      <div className="space-y-4">
                        <div className="inline-block px-6 py-2 bg-black/20 backdrop-blur-md rounded-full border border-white/10">
                          <p className="font-bold text-lg sm:text-xl uppercase tracking-wider">{house.motto}</p>
                        </div>
        ...
        <section className="py-16 bg-slate-50 relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
              <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeInUp}>
                <h2 className="text-[26px] sm:text-[38px] lg:text-[48px] font-bold leading-[1.1] uppercase tracking-tighter text-[#000000]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
              {[
                ...
                >
                  ...
                  <h3 className="text-2xl lg:text-3xl font-bold text-[#000000] mb-4 uppercase tracking-tight">{item.title}</h3>
