              ...
              >
                <div className="space-y-12">
                  ...
                  <div className="bg-gradient-to-br from-[#FDF6E3]/50 to-white p-8 rounded-3xl border border-[#D6B25E]/20">
                    <h2 className="text-2xl lg:text-3xl font-bold mb-4 text-[#000000] uppercase tracking-tighter">Welcome to Mapleford International School</h2>
                  ...
                  {/* Acceptance of Terms */}
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#000000] uppercase tracking-tighter">Acceptance of Terms</h2>
                  ...
                  {/* Use of Website */}
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#000000] uppercase tracking-tighter">Use of Website</h2>
                  ...
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">Intellectual Property Rights</h2>
                    <div className="bg-white p-6 rounded-2xl border border-gray-200 ">
                  ...
                  {/* User Submissions */}
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">User Submissions</h2>
                    <div className="bg-gradient-to-br from-[#FDF6E3]/50 to-white p-8 rounded-3xl border border-[#D6B25E]/20">
                      <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  {/* Admission Process */}
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">Admission Process</h2>
                    <div className="bg-white p-6 rounded-2xl border border-gray-200 ">
                      <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">Disclaimer of Warranties</h2>
                    <div className="bg-gradient-to-br from-[#FDF6E3]/30 to-white p-8 rounded-3xl border border-[#D6B25E]/20">
                      <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">Limitation of Liability</h2>
                    <div className="bg-white p-6 rounded-2xl border border-gray-200 ">
                      <p className="text-gray-700 leading-relaxed">
                  ...
                  {/* External Links */}
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">External Links</h2>
                    <div className="bg-gradient-to-br from-[#FDF6E3]/50 to-white p-8 rounded-3xl border border-[#D6B25E]/20">
                      <p className="text-gray-700 leading-relaxed">
                  ...
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">Modifications to Terms</h2>
                    <div className="bg-white p-6 rounded-2xl border border-gray-200 ">
                      <p className="text-gray-700 leading-relaxed">
                  ...
                  {/* Governing Law */}
                  <div>
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#1A1A1A] uppercase tracking-tighter">Governing Law</h2>
                    <div className="bg-gradient-to-br from-[#FDF6E3]/30 to-white p-8 rounded-3xl border border-[#D6B25E]/20">
                      <p className="text-gray-700 leading-relaxed">
                  ...
                  <div className="bg-gradient-to-br from-[#d0302b]/5 to-[#D6B25E]/5 p-10 rounded-3xl border-2 border-[#D6B25E]/30">
                    <h2 className="text-2xl lg:text-3xl font-bold mb-6 text-[#000000] uppercase tracking-tighter">Contact Us</h2>
